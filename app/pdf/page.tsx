...
import { PDF_PRIMARY_PROMPT, PDF_QUICK_STARTS } from "@/lib/pdf-sample-prompts";
    ...
    <div className="flex h-full bg-white">
      <div className="flex-1 min-w-0 flex flex-col">
        <div className="flex items-center gap-3 px-5 py-2.5 border-b border-[#E8E8E8] bg-white">
          <Image src="/icon-pdf.svg" alt="PDF" width={26} height={26} />
        ...
        <div className="flex-1 min-h-0">
          <ChatInterface
            key={chatKey}
            pillarId="pdf"
            primaryPrompt={PDF_PRIMARY_PROMPT}
            quickStarts={PDF_QUICK_STARTS as unknown as string[]}
